...
const Page = ({ params }) => {
  ...
  useEffect(() => {
    ...
    // Set up interval for mockup images
    ...
    // Cleanup interval on component unmount or when project_id changes
    return () => clearInterval(interval);
  }, [project_id, mockups.length]); // Depend on project_id and mockups length
  ...
  const fetchProjects = async () => {
    try {
      ...
      // const projects = data.success ? data.data : localProjects;
